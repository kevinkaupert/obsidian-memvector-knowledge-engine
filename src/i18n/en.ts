...
export const en: TranslationKeys = {
  ...
  relSuggestType: "Ask the AI to suggest a type",
  relSuggestVerify: "Ask the AI to check the selected type",
  relSuggestNoResult: "⚠️ Couldn't parse the AI's response.",
  relSuggestError: "AI request failed",
  relCustom: "Custom...",
