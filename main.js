...
var VectorScatterView = class extends import_obsidian4.ItemView {
  ...
  async onOpen() {
    ...
    // 2. Floating Right-Hand Graph Control Panel (Native Obsidian Style)
    const controlPanel = container.createEl("div", {
      style: "position: absolute; top: 12px; right: 12px; width: 260px; max-height: calc(100% - 60px); z-index: 20; background: var(--background-secondary, rgba(24, 24, 37, 0.92)); backdrop-filter: blur(12px); border: 1px solid var(--background-modifier-border, rgba(255, 255, 255, 0.08)); border-radius: 8px; padding: 12px; overflow-y: auto; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.35); font-size: 0.82em;"
    });
    ...
    hoverBar.style.bottom = "12px";
    hoverBar.style.left = "12px";
    hoverBar.style.right = "284px";
    hoverBar.style.padding = "6px 12px";
    hoverBar.style.borderRadius = "6px";
    hoverBar.style.border = "1px solid var(--background-modifier-border, rgba(255, 255, 255, 0.08))";
    hoverBar.style.background = "var(--background-secondary, rgba(15, 23, 42, 0.9))";
    hoverBar.style.backdropFilter = "blur(8px)";
    hoverBar.style.fontSize = "0.82em";
