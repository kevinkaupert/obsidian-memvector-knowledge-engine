...
export const de: TranslationKeys = {
  ...
  relSuggestType: "Typ per KI vorschlagen lassen",
  relSuggestVerify: "Ausgewählten Typ per KI prüfen",
  relSuggestNoResult: "⚠️ KI-Antwort konnte nicht ausgewertet werden.",
  relSuggestError: "KI-Anfrage fehlgeschlagen",
  relCustom: "Frei...",
