...
export const en: TranslationKeys = {
  ...
  relDeleteConfirm: "Really delete this relation? The file under wiki/relations/ will be moved to trash and the edge removed from the Memgraph server.",
  relDeleting: "Deleting...",
  relDeleteSuccess: "Relation deleted (file + Memgraph edge).",
  relDeleteSyncWarning: "Could not delete the Memgraph edge",
