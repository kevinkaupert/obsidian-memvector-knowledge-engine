...
export const en: TranslationKeys = {
  ...
  agentsIncludeDesc: "Include the vault's own AGENTS.md (or the configured guideline files) as house-style guidance in the synthesis prompt.",
  scatterStyleName: "2D canvas visual style",
  scatterStyleDesc: "How nodes and edges are rendered: monochrome (neutral dots, color only on selection), muted (desaturated per-type colors), or ink (outline-only dots, glow for connected notes).",
  showRelationNotesDesc: "Render relation notes (wiki/relations/) as nodes in the 2D canvas. Off by default - relations stay visible as typed edges while the relation files themselves are hidden.",
  relVocabPathName: "Active vocabulary file",
  relVocabPathDesc: "Vault path of the file defining the relation types offered in the relation editor. Normally managed via the preset selector above - only edit this directly for a custom file outside wiki/presets/.",
  ...
  secRelationTypes: "4. Relation Types",
  relPresetName: "Active preset",
  relPresetDesc: "Named vocabulary presets stored in your vault (wiki/presets/). Switching reloads the vocabulary in memory - no re-indexing needed, because edge labels are stored as strings in SQLite. Free-text types saved from the Relation Builder are appended to the active preset's file under \"Custom\".",
  relPresetCustomOption: "Custom file (current path)",
  relPresetNewBtn: "+ New preset",
  relPresetRenameBtn: "Rename",
  relPresetDeleteBtn: "Delete",
  relPresetActivated: "Preset activated.",
  relPresetCreated: "Preset created.",
  relPresetRenamed: "Preset renamed.",
  relPresetDeleted: "Preset deleted.",
  relPresetError: "Preset action failed:",
  relPresetNameModalTitle: "Preset name",
  relPresetNameModalOk: "OK",
  relPresetNameModalCancel: "Cancel",
  relTypesInPreset: "Types in active preset",
  relTypeColLabel: "Label",
  relTypeColCategory: "Category",
  relTypeColWeight: "Weight",
  relTypeColDirection: "Direction",
  relTypeColRepels: "Repels",
  relTypeAddBtn: "+ Add type",
  relTypeAddLabelPlaceholder: "Cypher label (e.g. TEACHES)",
  relTypeAddCategoryPlaceholder: "Category (e.g. Custom)",
  relTypeAddBidirectional: "Bidirectional",
  relTypeAddRepels: "Repels (push apart)",
  relTypeAdded: "Type added.",
  ...
  relTypeWriteError: "Could not write the vocabulary file.",
