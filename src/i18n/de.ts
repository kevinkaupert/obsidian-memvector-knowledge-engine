...
export const de: TranslationKeys = {
  ...
  // Section 5: Memgraph
  secMemgraph: "5. Graph-Datenbank (Memgraph oder lokal)",
  graphBackendName: "Graph-Backend",
  graphBackendDesc: "Wähle, wo Beziehungen und der Vault-Graph gespeichert werden.",
  graphBackendMemgraph: "Memgraph (Server)",
  graphBackendSqlite: "Lokal (SQLite, kein Server nötig)",
  graphBackendLocalInfo: "Lokale Datei: .obsidian/plugins/obsidian-memvector-knowledge-engine/memvector-local.sqlite",
  ...
  memgraphAutoSyncName: "Automatische Synchronisierung",
  memgraphAutoSyncDesc: "Speichere erstellte Beziehungen sofort in der gewählten Graph-Datenbank.",
  ...
  relDeleteConfirm: "Diese Beziehung wirklich löschen? Die Datei unter wiki/relations/ wird in den Papierkorb verschoben und die Kante aus der Graph-Datenbank entfernt.",
  relDeleting: "Lösche...",
